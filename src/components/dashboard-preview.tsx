      ...
      <div className="grid min-h-[390px] grid-cols-[54px_1fr] sm:grid-cols-[170px_1fr]">
        ...
        <div className="min-w-0 p-4 sm:p-7">
          ...
          <div className="mt-7 grid gap-3 sm:grid-cols-[1.15fr_.85fr]">
            <div className="rounded-lg border border-border p-4"><div className="flex items-center justify-between"><p className="text-xs font-medium">Levy collection</p><span className="text-xs text-muted-foreground">—</span></div><div className="mt-8 flex h-24 items-end gap-2">{[0,1,2,3,4,5,6].map(i=><span key={i} className="h-1 flex-1 rounded-full bg-muted"/>)}</div></div>
